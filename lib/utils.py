...
def parse_args(available_nets):
    import argparse
    default_cache = os.path.realpath(os.path.join(
    ...
    parser.add_argument("--eval", type=str, default=None,
                        help="path to model file to be evaluated")
    parser.add_argument("--resume", type=str, default=None,
                        help="path to model file to be resumed")
    parser.add_argument("--train-net", type=str,
                        default=available_nets[0], help="train on one of following nets: %s" % (str(available_nets)))
    ...
    parser.add_argument("--cache", type=str, default=default_cache,
                        help="where to store training meta-data and final model")
    parser.add_argument("--estimated-3DBB", type=str, default=None,
                        help="use estimated 3DBBs from specified path")
    parser.add_argument("--test", type=str, default=None,
                        help="image to be test")
    parser.add_argument("--test-idx", type=int, default=None,
                        help="image index to be test")
    parser.add_argument("--demo", type=str, default=None,
                        help="video to be test")
    ...
    if args.eval is None and args.resume is None:
        assert args.train_net in available_nets, "--train-net must be one of %s" % (
            str(available_nets))
